    ...
    for name in names:
        ...
        spawn_voter_cmds.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(pkg_moss_control, 'launch', '_voter.launch.py')),
                launch_arguments={
        ...
        spawn_movement_cmds.append(
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(os.path.join(pkg_moss_control, 'launch', '_movement.launch.py')),
                launch_arguments={
                                  'robot_name': name['name'],
                                  'robot_namespace': name['name'],
                                  'swarm_amount': str(swarm_amount)
